						...
						<form action="/ASSIGNTMENT_GD2/change" method="post">
							...
							<div class="form-check">
								<input class="form-check-input" type="hidden" name="admin"
									...
									${!sessionScope.currentUser.admin?'checked':''}>
							</div>
							...
							<div class="form-floating mb-3">
								<input type="currentPassword" class="form-control"
									id="floatingPassword" placeholder="Password"
									value="${sessionScope.currentUser.password}" name="password">
								<label style="color: rgba(5, 0, 0, 0.416) for="floatingPassword">Current
									PassWord</label>
							</div>
							...
							<div class="form-floating mb-3">
								<input type="password" class="form-control"
									id="floatingPassword" placeholder="password" name="newpass">
								<label for="floatingPassword"
									style="color: rgba(5, 0, 0, 0.416)">New PassWord</label>
							</div>
							...
							<div class="form-floating mb-3">
								...
								<label for="floatingPasswordConfirm"
									style="color: rgba(5, 0, 0, 0.416">Confirm New Password</label>
							</div>
