		...
		<div class="row">
			<div class="col-lg-10 col-xl-9 mx-auto">
				<div
					...
					<div class="edit card-img-left d-none "></div>
					<img alt="" src="/ASSIGNTMENT_GD2/image/editFrofile.jpg"
						style="height: 520px; width: 440px; margin-left: 20px; margin-top: 40px">

					<div class="card-body p-4 p-sm-5">
						<h5 class=" card-title text-center mb-3 fw-light fs-5">EDIT
							FROFILE</h5>
						<h3>${messageEdit}</h3>
						<div style="text-align: center;">
							<a href="detail.html"> <img
								src="/ASSIGNTMENT_GD2/image/user.jpg" class="img-fluid"
								style="height: 100px; width: 50%;" alt=""></a>
						</div>

						<form method="post" action="/ASSIGNTMENT_GD2/editPro">
							<div class="form-floating mb-3">
								<input type="text" class="form-control"
									value="${sessionScope.currentUser.id}" name="id"
							...
							<div class="form-floating mb-3">
								<input type="text" class="form-control"
									value="${sessionScope.currentUser.password}" name="password"
							...
							<hr>
							<div class="form-floating mb-3">
								<input type="text" class="form-control" id="floatingFullName"
									value="${sessionScope.currentUser.fullname}" name="fullname"
									placeholder="FullName"> <label for="floatingFullName">FullName</label>
							</div>
							<div class="form-floating mb-3">
								<input type="email" class="form-control" id="floatingInputEmail"
									value="${sessionScope.currentUser.email}" name="email"
							...
							<div class="form-check">
								<input class="form-check-input" type="radio" name="admin"
									value="true" ${sessionScope.currentUser.admin?'checked':''}>
							...
							<div class="form-check">
								<input class="form-check-input" type="radio" name="admin"
									...
									${!sessionScope.currentUser.admin?'checked':''}> <label
							...
							<div class="d-grid mb-2">
								<button
									...
									type="submit" formaction="/ASSIGNTMENT_GD2/editPro?id" >Update</button>
							</div>
