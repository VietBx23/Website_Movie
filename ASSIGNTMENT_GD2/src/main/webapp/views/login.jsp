			...
			<div class="col-lg-10 col-xl-9 mx-auto">
				<div
					...
					<div class="login card-img-left d-none d-md-flex">
						<img alt="" src="/ASSIGNTMENT_GD2/image/RegisterPassWord.jpg">
					</div>
					<div class="card-body p-4 p-sm-5">
						<h5 class="card-title text-center mb-5 fw-light fs-5">LOGIN</h5>
						<h3>${messageLogin}</h3>
						<form action="/ASSIGNTMENT_GD2/login"  method="post">
							<div class="form-floating mb-3">
								<input type="text" class="form-control" name="username"
									id="floatingInput" placeholder="UserName"> <label
									for="floatingInput" style="color:  rgba(5, 0, 0, 0.416">UserName</label>
							</div>
							<div class="form-floating mb-3">
								<input type="password" class="form-control"
									id="floatingPassword" name="password" placeholder="password">
								<label for="floatingPassword" style="color:  rgba(5, 0, 0, 0.416">Password</label>
							</div>

							<div class="form-check mb-3">
								<input class="form-check-input border-dark" type="checkbox"
									value="" id="rememberPasswordCheck"> <label
									class="form-check-label" for="rememberPasswordCheck" style="color:  rgba(5, 0, 0, 0.416">
									Remember password </label>
							</div>
							<div class="d-grid">
								<button class="btn btn-primary btn-login text-uppercase fw-bold"
									type="submit" formaction="login" >Login</button>
							</div>
							<a class="d-block text-center mt-2 small"
								href="http://localhost:8080/ASSIGNTMENT_GD2/account/sign-up">Have
							...
							<div class="d-grid mb-2">
								<button
									...
									type="submit">
									<i class="fab fa-facebook-f me-2"></i> Login in with Facebook
								</button>
							</div>
							<div class="d-grid " style="text-align: center;">
								<a href="http://localhost:8080/ASSIGNTMENT_GD2/index"
